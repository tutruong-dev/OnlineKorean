  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-section recent-courses">
        ...
        <ul>
          <li><button><img src="hoc.jpg" alt="Luyện Nói Nâng Cao" /><span>Luyện Nói Nâng Cao</span></button></li>
          <li><button><img src="hoc.jpg" alt="Luyện Thi Topik III" /><span>Luyện Thi Topik III</span></button></li>
          <li><button><img src="hoc.jpg" alt="Khóa Luyện Đọc Trung Cấp" /><span>Khóa Luyện Đọc Trung Cấp</span></button></li>
        </ul>
      </div>
